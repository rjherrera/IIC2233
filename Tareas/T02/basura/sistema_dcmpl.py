...
class _Sistema:
    ...
    def __init__(self, n):
        ...
        self._Sistema__objetivo = rd.choice(ultimos)
        self._Sistema__nodo_actual = self._Sistema__mapa[0]
        self._Sistema__enemigo_nodo_actual = rd.choice(self._Sistema__mapa[1:])
...
def _generar_caminos(n):
    ...
    for i in range(n):
        if len(faltantes) == 0:
            ...
            obj = faltantes.pop(rd.randint(0, len(faltantes) - 1))
